<?php
session_start();
$conn = mysqli_connect("localhost","root","root","foodies");
if(!$conn){  
...
{  
	...
	$sql1 = "INSERT INTO login(`email`, `password`) VALUES ('$email', '$pw');";
...
<BODY  background="background1.jpg" link="white" alink="white" vlink="white">
...
<TABLE style="margin-left:400px" border="1" bordercolor="white">
...
<OPTION VALUE="Kandivali West" style="color:black;">Shivaji Nagar</OPTION>
<OPTION VALUE="Kandivali East" style="color:black;">SB Road</OPTION>
<OPTION VALUE="Borivali East" style="color:black;">Model Colony</OPTION>
<OPTION VALUE="Borivali West" style="color:black;">Apte Road</OPTION>
</SELECT></TD>
</TR>
<TR class="left">
...
<center><P><INPUT TYPE="Submit" value="Submit" name="submit" id="submit" class="button" onclick="if(!this.form.tc.checked){alert('You must agree to the terms first.');return false}">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<INPUT TYPE="Reset" value="Reset" id="reset" class="button"></P></FORM><center>
<HR width="1000">
